...
silent only
silent tabonly
cd ~/Workspace/scaler/Java/class
...
badd +9 ~/Workspace/scaler/Java/class/twoPointer.java
badd +1 ~/Workspace/scaler/WebDev/2029-Web-dev-2-Group-C/Class-1(Introduction\ to\ DOM)/1.html
badd +0 contributing.java
argglobal
%argdel
$argadd contributing.java
edit ~/Workspace/scaler/Java/class/twoPointer.java
argglobal
